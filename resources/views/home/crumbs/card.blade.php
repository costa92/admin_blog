<div class="card">
    <h2>我的名片</h2>
    <p>网名：CostaLong | 演绎山地 </p>
    <p>职业：PHP 开发工程师 </p>
    <p>现居：广东省-深圳市</p>
    <p>Email：longqiuhong@163.com</p>
    <ul class="linkmore">
        ...
        <li><a href="http://wpa.qq.com/msgrd?v=3&uin=944310536&site=qq&menu=yes" target="_blank" class="iconfont icon---" title="QQ联系我"></a></li>
